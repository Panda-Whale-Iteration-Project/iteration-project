...
const CategoryDropDownMenu = ({ closeDropDown, setDropDownSelection }) => {
  ...
  return (
    <div>
      <div
        className='right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-y-auto max-h-60'
